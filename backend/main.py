...
async def submit_answer(
    ...
    try:
        # Run AI pipeline
        clean_vocab_prompt = "Technical software engineering interview answer covering skills, projects, and architecture."
        transcription = transcribe_audio(str(audio_path), prompt=clean_vocab_prompt)
